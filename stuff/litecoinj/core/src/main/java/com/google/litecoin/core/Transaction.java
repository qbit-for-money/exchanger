...
import com.google.litecoin.crypto.TransactionSignature;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.litecoin.script.Script, ECKey, com.google.litecoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.litecoin.core.Transaction.SigHash, boolean)}
